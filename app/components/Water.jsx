      ...
      <shaderMaterial
        vertexShader={`
          ...
          void main(){
              ...
              elevation += sin(modelPosition.x * uWaveFrequency + uTime * uSpeed);
              elevation *= sin(modelPosition.z * uWaveFrequency + uTime * uSpeed) * uWaveDepth;

              for(float i = 1.0; i <= 3.0; i++)
              {
                  elevation -= abs(cnoise(vec3(modelPosition.xz * 0.9 * i, uTime * 0.1)) * 0.15 / i);
              }
